    ...
    <>
      ...
      <section className="container" style={{ paddingTop: '5rem', paddingBottom: '4rem' }}>
        <div className="page-header">
          <div className="form-icon" style={{ width: '50px', height: '50px', fontSize: '1.4rem' }}>⭐</div>
          <h2 style={{ fontSize: '2rem' }}>Chef's Highlights</h2>
          <p>Signature dishes recommended by our master chefs</p>
        </div>
